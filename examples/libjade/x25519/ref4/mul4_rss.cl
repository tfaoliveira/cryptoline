...
(* fails to check:
assert eqmod 
       (limbs 64 [r8, rcx, rdi, rbp, rsi, rbx, r12, r11])
...
assert true
       &&
       eqmod 
       (limbs 64 [r8, rcx, rdi, rbp, rsi, rbx, r12, r11, 0@64])
       (limbs 64 [f0, f1, f2, f3, 0@64, 0@64, 0@64, 0@64, 0@64] *
        limbs 64 [g0, g1, g2, g3, 0@64, 0@64, 0@64, 0@64, 0@64])
       ((2**255)-19)@576;
